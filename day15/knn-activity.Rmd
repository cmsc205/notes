...
In this activity, we will perform KNN on the [`Caravan`](https://raw.githubusercontent.com/cmsc205/notes/master/day15/Caravan.csv) data set from the `ISLR` package. The data are available on the course webpage. Let's start by loading a few useful packages.
