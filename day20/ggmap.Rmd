...
4.  The file `CAquakes.csv` contains data on earthquakes in California from January 1, 2010 through the end of 2015. Use `ggmap` to plot the earthquakes that occurred in California during this time, similar to what we did for Oklahoma above. Do any patterns emerge? 
